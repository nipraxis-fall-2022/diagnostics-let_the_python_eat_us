...
```
cd data
curl -L https://figshare.com/ndownloader/files/34951740 -o group_data.tar #curl.exe or it freaks out for me (see: https://stackoverflow.com/questions/30807318/running-curl-via-powershell-how-to-construct-arguments)
